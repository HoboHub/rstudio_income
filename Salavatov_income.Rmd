...
## Исследование зависимостей дохода от различных параметров

Это дополнительный материал к курсовой работе.
Студент: Салаватов М.В.
ИВТ 1.1
...
График распределения людей с доходом больше или меньше $50К

```{r income_count, echo=FALSE}
...
Распределение доходов среди пенсионеров

```{r age_old, echo=FALSE}
...
Распределение доходов по разным возрастным группам

```{r income_age, echo=FALSE}
